...
ASSETS_URL = (
    f"http://storage.googleapis.com/dm-meltingpot/meltingpot-assets-{ASSETS_VERSION}.tar.gz"
)
...
class BuildPy(build_py.build_py):
    ...
    def download_and_extract_assets(self):
        ...
        tar_file_path = os.path.join(self.get_package_dir("assets"), os.path.basename(ASSETS_URL))
    ...
    def build_assets(self):
        ...
        print(f"copied assets from {package_root}/assets to {build_root}/assets", flush=True)
